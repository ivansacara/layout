export default {
  ...
  contactsPage: {
    ...
    bottomText: "Если вы хотите заказать проект, заполните, пожалуйста, форму."
  },
  popUpForm: {
    title: "Оставьте заявку",
    textTop: "Хотите получить бесплатную консультацию или заказать проект?",
    textBottom: "Менеджер свяжется с Вами в ближайшее время."
  },
  contactForm: {
    name:"Имя",
    mail:"Email",
